...
public class Main {
	...
	/**
	 * Adiciona um circulo 'a coleccao de formas geometricas, caso o identificador
	 * dado nao exista. Se ja existir, nao faz nada.
	 * 
	...
	/**
	 * Adiciona um rectangulo 'a coleccao de formas geometricas, caso o
	 * identificador dado nao exista. Se ja existir, nao faz nada.
	 * 
	 * @param in     - o input de onde os dados vao ser lidos.
	 * @param shapes - o ShapesCollection no qual se pretende adicionar o
	 *               rectangulo.
	 */
	 ...
	 * 
	 * @param shapes - o ShapesCollection sobre qual se pretende efectuar a
	 *               listagem.
	 */
	private static void listShapes(ShapesCollection shapes) {
		if (shapes.isEmpty())
			...
			ShapeIterator it = shapes.listShapes();
			while (it.hasNext()) {
				String id = it.current().getId();
				String shape = it.current().getShape();
				int x = it.current().getX();
				int y = it.current().getY();

				it.next();

				System.out.println(id + " (" + x + ", " + y + ") " + shape);
			}
			System.out.println();
		}
	}
	...
	/**
	 * Move uma forma geometrica, caso o identificador dado exista. Se nao existir,
	 * nao faz nada.
	 * 
	 * @param in     - o input de onde os dados vao ser lidos.
	 * @param shapes - o ShapesCollection no qual se pretende mover a forma
	 *               geometrica.
	 */
	...
	private static void minArea(ShapesCollection shapes) {
		if (shapes.isEmpty())
			...
			String id = shapes.getSmallestShape().getId();
			String shape = shapes.getSmallestShape().getShape();
			int x = shapes.getSmallestShape().getX();
			int y = shapes.getSmallestShape().getY();
